...
public class GupshupMock {
    ...
    public static final Map<String, String> SMS_MOCKED_RESPONSES = new HashMap<>();
    public static final Map<String, String> EMAIL_MOCKED_RESPONSES = new HashMap<>();

    public static final Map<String, String> SMS_DELIVERY_STATUS_MOCKED_RESPONSES = new HashMap<>();

    public static final Map<String, String> PN_MOCKED_RESPONSES = new HashMap<>();
